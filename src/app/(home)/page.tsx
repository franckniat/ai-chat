                    ...
                    <div className="flex items-center flex-col justify-center gap-5">
                        ...
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center font-mono">
                            ...
                            <span className="text-primary relative">
                                ai
                                <span className="absolute top-12 md:top-16 left-0 w-full h-0.5  bg-gradient-to-r from-primary via-base-100/50 to-primary rounded-full" />
                            </span>
                        </h1>
                        ...
                        <div className="flex max-sm:flex-col items-center gap-3 pt-3 sm:justify-center w-full">
                            <Link href={"/chat"} className={cn(buttonVariants({ variant: 'default', size: 'lg' }), 'max-sm:w-full')}>
                                Try for free
                            </Link>
                            <Link className={cn(buttonVariants({ variant: 'ghost', size: 'lg' }), 'group max-sm:w-full')} href="/pricing">
                                Our pricing
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="18"
