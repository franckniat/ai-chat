                ...
                <div className="max-w-[1280px] mx-auto px-4 text-center">
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <Link href="/chat?model=gpt-4o-mini&source=home">
                            <Badge variant="outline" className="px-4 py-2 text-sm rounded-full backdrop-blur-sm">
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                            Experience the next generation of AI chat. Seamlessly switch between models, 
                            analyze documents, and boost your productivity with Niato AI.
                        </p>

                        {/* Primary Call to Actions */}
                        <div className="flex flex-col sm:flex-row items-center gap-4 mt-4 w-full sm:w-auto">
                            <Link href="/chat" className={cn(buttonVariants({ size: 'lg' }), "w-full sm:w-auto px-8 text-lg h-12 rounded-full shadow-lg hover:shadow-primary/25 transition-all")}>
                                Start Chatting
                                <MessageSquare className="ml-2 h-5 w-5" />
                            </Link>
                            <Link href="/pricing" className={cn(buttonVariants({ variant: 'outline', size: 'lg' }), "w-full sm:w-auto px-8 text-lg h-12 rounded-full")}>
                                View Pricing    
                            </Link>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-muted/30">
                <div className="max-w-[1280px] mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Why choose Niato AI?</h2>
                        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                            Built for developers, creators, and professionals who need reliable AI assistance.
                        </p>
                    </div>
            ...
            */}
            <section className="py-20 px-6">
                <div className="max-w-[1000px] mx-auto bg-primary/5 rounded-3xl p-8 md:p-16 text-center border border-primary/10">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to supercharge your productivity?</h2>
                    <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Join thousands of users who are already using Niato AI to work smarter, not harder.
                    </p>
                    <Link href="/chat" className={cn(buttonVariants({ size: 'lg' }), "px-10 py-6 text-xl rounded-full shadow-xl hover:shadow-2xl transition-all")}>
