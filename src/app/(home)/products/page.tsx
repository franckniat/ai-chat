...
export const metadata: Metadata = {
    ...
    description:
        'What niato ai can do: cost-efficient Google Gemini models behind one composer, rendered code and math, a searchable history, and selectable answer tones.',
...
const mainFeatures: Feature[] = [
    {
        ...
        description:
            `Pick among ${modelCount} Google models without leaving the conversation. The selector sits under the composer, and your choice applies to the next message — the thread is never reset.`,
        icon: MessageSquare,
        highlights: [
            "Grouped by cost: Budget, Balanced, Advanced",
    ...
    {
        title: "Costs kept in check",
        description:
            "Answers are billed per token, so the app avoids spending them. Model reflection is switched off, only the recent part of a thread is replayed to the model, and the cheapest model is the default.",
        icon: Wallet,
        highlights: [
            "Reflection disabled: it cost 6x more tokens than the answer itself",
            "Only the last 20 messages of a thread are sent back",
            "Conversation titles are generated by the cheapest model, capped short",
            "Falls back to the next cheapest model, never a pricier one",
        ],
    },
    {
